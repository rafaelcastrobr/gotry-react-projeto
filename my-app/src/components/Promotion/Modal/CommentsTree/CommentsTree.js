  ...
  function renderItem(item) {
    ...
    return (
      <li className="promotion-modal-comments-tree__item">
        <img src={item.user.avatarUrl} alt={`foto de ${item.user.name}`} className="promotion-modal-comments-tree__item__avatar" />
        <div className="promotion-modal-comments-tree__item__info">
          ...
          <button onClick={() => {
            ...
            type="button" className="promotion-modal-comments-tree__answer-button"
          >
            Responder
          </button>
          ...
          {activeCommentBox === item.id && (
            <div className="promotion-modal-comments-tree__comment-box">
              ...
              <button type="button" className="promotion-modal-comments-tree__send-button"
                onClick={() => {
